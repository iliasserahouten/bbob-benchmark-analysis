...
Iliass.Erahouten@etu.eilco.univ-littoral.fr, Aya.Eddib@etu.eilco.univ-littoral.fr}
}
...
Dans ce travail, nous comparons trois algorithmes aux approches contrast\'ees : BIPOP-CMA-ES~\cite{hansen2009bipop}, un algorithme \'evolutionnaire robuste bas\'e sur l'adaptation de la matrice de covariance ; PSO-BFGS~\cite{voglis2012mempsode}, une m\'ethode hybride combinant exploration globale et optimisation locale ; et RANDOMSEARCH-5~\cite{brockhoff2017randomsearch}, une strat\'egie al\'eatoire servant de r\'ef\'erence de base.
...
\textbf{RANDOMSEARCH-5} repose sur un \'echantillonnage al\'eatoire uniforme de l'espace de recherche, avec un budget de $5 \times 10^7 \cdot D$ \'evaluations. Il constitue une m\'ethode de r\'ef\'erence simple, permettant de mesurer le gain apport\'e par des algorithmes plus sophistiqu\'es~\cite{brockhoff2017randomsearch}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{plot/single_run_BIPOP-CMA-ES_f1.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{plot/all_runs_BIPOP-CMA-ES_f1.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{convergence_all_functions.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{plot/convergence_all.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{plot/boxplots_all.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{ecdf_all_functions.pdf}
...
Les courbes ECDF sont largement utilis\'ees dans la plateforme BBOB pour comparer de mani\`ere globale les performances des algorithmes en termes de vitesse et de taux de succ\`es~\cite{hansen2021coco}.
...
Enfin, sur la fonction f24 (Lunacek), extr\^emement difficile, les performances chutent fortement pour tous les algorithmes. BIPOP-CMA-ES ne r\'eussit que dans un seul run (1/15), tandis que PSO-BFGS et RANDOMSEARCH-5 \'echouent compl\`etement (0/15); Ce comportement est attendu, car les m\'ethodes de recherche al\'eatoire pure souffrent fortement de la dimension du probl\`eme et de l'absence de m\'ecanisme d'apprentissage~\cite{auger2009random}.. Cela souligne la complexit\'e du paysage d'optimisation et les limites des m\'ethodes \'etudi\'ees.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{plot/ert_bar_chart.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{plot/ecdf_aggregated.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{plot/heatmap_performance.pdf}
...
\bibitem{brockhoff2017randomsearch}
D.~Brockhoff,
``COCO BBOB Benchmark Data for RANDOMSEARCH-5,''
2017. [Online]. Available: \url{https://numbbo.github.io/data-archive/}
